    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 col-md-9 col-lg-10 py-5">
                <h1 class="mb-5 text-center">Administrador de usuarios</h1>
                <div class="mb-3">
                    <a href="agregar-usuario.php" class="agregar-usuario"><i class="fa fa-plus-circle mr-1"></i>Agregar usuario</a>
                </div>
                <div class="row px-2">
                    <?php
